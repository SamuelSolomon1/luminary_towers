...
<div class="mainbooking border border-primary">
    <div class="container">
        <div class="row">
            <h1> SOCIAL LOUNGE</h1>
            <div class="col-lg-7 col-sm-12" id="box-left">
            ...
            <div class="col-5 " id="box-right ">
               <div class="col-4 col-sm-7 centered" id="formRightSide">
               <p>From</p>
