...
<head>
    ...
    <title>Booking</title>
    <link rel="stylesheet" href="Booking_Swimming.css">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7" id="box-left">
                ...
                <div class="big-img">
                    <img src="images/swimming/1.jpg">
                </div>

                <div class="images">
                    <div class="small-img">
                        <img src="images/swimming/2.jpg" onclick="showImg(this.src)">
                    </div>

                    <div class="small-img">
                        <img src="images/swimming/rockwell-grove.webp" onclick="showImg(this.src)">
                    </div>

                    <div class="small-img">
                        <img src="images/swimming/23.jpg" onclick="showImg(this.src)">
                    </div>

                    <div class="small-img">
                        <img src="images/swimming/25.jpg" onclick="showImg(this.src)">
                    </div>
