...
<body>
                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                            <li class="nav-item">
                                ...
                                <a class="nav-link active" aria-current="true" href="/pages/community.php">Administrative</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/pages/community-billing.php">Billing & Collection</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="/pages/community-engineering.php">Engineering</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title">Online Forms</h5>
                        <hr>
                        <!-- table starts-->
                        <div class="container">
                            <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Amenity Reservation and Agreement Form (PDF, 166 KB)</td>
                                                    <td>Fill-up this form for clubhouse and function room reservations.</td>
                                                </tr>
                                                <tr>
                                                    <td>Application for Final Inspection and Bond Refund Form (PDF, 298 KB) </td>
                                                    <td>Fill-up this form for unit renovation bond refund.</td>
                                                </tr>
                                                <tr>
                                                    <td>Application for Unit Renovation Form (PDF, 194 KB)</td>
                                                    <td>Fill-up this form to apply for unit renovation.</td>
                                                </tr>
                                                <tr>
                                                    <td>Concern Slip Form (PDF, 725 KB)</td>
                                                    <td>Fill-up this form for unit concerns.</td>
                                                </tr>
                                                <tr>
                                                    <td>Gate Pass Form (PDF, 147 KB)</td>
                                                    <td>Fill-up this form for items to be delivered and/or carried into the unit and for items to be pulled out from the unit.</td>
                                                </tr>
                                                <tr>
                                                    <td>Guest Authorization Form (PDF, 566 KB)</td>
                                                    <td>Fill-up this form for guest authorization.</td>
                                                </tr>
                                                <tr>
                                                    <td>Health and Travel History Declaration Form (PDF, 173 KB)</td>
                                                    <td>Fill-up this form for health and travel history declarations.</td>
                                                </tr>
                                                <tr>
                                                    <td>Move-In Clearance for Tenant Form (PDF, 162 KB)</td>
                                                    <td>Fill-up this form for lease units together with the Tenant Information Sheet form and submit the following: <br>
                                                        Notarized Lease of Contract <br>
                                                        Two (2) valid IDs of Tenant</td>
                                                </tr>
                                                <tr>
                                                    <td>Move-Out Clearance for Tenant Form (PDF, 160 KB)</td>
                                                    <td>Fill-up this form for lease units.</td>
                                                </tr>
                                                <tr>
                                                    <td>Resident RFID Application Form (PDF, 171 KB)</td>
                                                    <td>Fill-up this form to apply for a Resident RFID.</td>
                                                </tr>
                                                <tr>
                                                    <td>Service Menu Request Form (PDF, 272 KB)</td>
                                                    <td>Fill-up this form to avail PMO's services.</td>
                                                </tr>
                                                <tr>
                                                    <td>Tenant Information Sheet Form (PDF, 339 KB)</td>
                                                    <td>Fill-up this form for unit tenant and family members' information.</td>
                                                </tr>
                                                <tr>
                                                    <td>Unit Owner Information Sheet Form (PDF, 166 KB)</td>
                                                    <td>Fill-up this form for unit owner and family members' information.</td>
                                                </tr>
                                                <tr>
                                                    <td>Vehicle Sticker Application Form (PDF, 158 KB)</td>
                                                    <td>Fill-up this form to apply for a Vehicle ID sticker.</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
    ...
    <div class="col-lg-12 col-md-6 mb-4 mb-lg-0 text-white text-center" id="copyRight">
        <div id="copyNote">
            &copy; 2016 - 2023 Luminary Towers Condominium Corporation. All rights reserved.
        </div>
    </div>
    <!-- footer ends -->
   <!-- sroll to top -->
