        ...
        <div class="container mainbooking">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1>
                            <a href="../pages/ammenities.php"><i class='fas fa-arrow-left' style='font-size:40px'></i></a>
                            SOCIAL LOUNGE
                        </h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-sm-12" id="info" style="display: none;">
                            ...
                            4. Operating hour of the function room is from 7:00 am to 12:00 midnight; function room must be clean and vacated before 1:00 am<br>
