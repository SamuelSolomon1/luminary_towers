...
<head>
    ...
    <title>Booking</title>
    <link rel="stylesheet" href="Booking_Lounge.css">
...
<body>
    ...
    <div class="container">
        <div class="row">
            <h1> SOCIAL LOUNGE</h1>
            <div class="col-lg-7" id="box-left">

                <div class="big-img">
                    <img src="https://media-cdn.tripadvisor.com/media/photo-s/18/37/16/74/social-lounge.jpg">
                </div>

                <div class="images">
                    <div class="small-img">
                        <img src="https://avatars.mds.yandex.net/i?id=295b1361cb8163e69b9a361975d78b54_l-5870057-images-thumbs&n=13" onclick="showImg(this.src)">
                    </div>

                    <div class="small-img">
                        <img src="https://media-cdn.tripadvisor.com/media/photo-s/18/37/16/74/social-lounge.jpg" onclick="showImg(this.src)">
                    </div>
            ...
            <div class="col-sm-3" id="box-right">
                <span>From</span><br>
                <h1>₱ 4000 </h1>
                <span>first four (4) hours</span>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col">
                    ...
                    6. Gambling is strictly not allowed inside the function room.<br>

                    12. Smoking inside the function room is strictly prohibited. Guest will be advised to smoke in the designated smoking area.<br>

                    7. The residents who reserved the function room shall be responsible for the actions of his/her guests at all times. He/she shall see to it that there will be no disturbing activity/ies such as loud and offensive music, unruly actions and loitering in any other places of Luminary Towers.<br>
                </div>
